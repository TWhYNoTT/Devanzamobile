          ...
          <View style={{ flexDirection: 'column', width: Dimensions.get('screen').width }}>
            <View style={{ flexDirection: 'row', width: Dimensions.get('screen').width }}>
              <CCInput {...this._inputProps("number")}
                ...
                containerStyle={[s.inputContainer, inputContainerStyle, { width: Dimensions.get('screen').width }]} />
            </View>
            <View style={{ flexDirection: 'row', width: Dimensions.get('screen').width, marginTop: moderateScale(20) }}>
              <View style={{ flex: 1 }}>
