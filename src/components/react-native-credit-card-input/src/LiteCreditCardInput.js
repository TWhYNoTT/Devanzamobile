...
const s = StyleSheet.create({
  container: {
    ...
    borderBottomWidth: moderateScale(1), paddingBottom: moderateScale(0), marginBottom: moderateScale(20)
  },
  icon: {
    width: moderateScale(30),
    height: moderateScale(25),
    resizeMode: "contain", marginBottom: moderateScale(5), marginEnd: moderateScale(10), marginStart: moderateScale(-10)
  },
  expanded: {
    flex: 1,
  },
    ...
    return (
      <View>
        ...
        <View style={{ flexDirection: 'row', marginTop: moderateScale(20) }}>
          <View style={{ flex: 1, borderBottomWidth: moderateScale(1), borderBottomColor: theme.colors.gray }}>
