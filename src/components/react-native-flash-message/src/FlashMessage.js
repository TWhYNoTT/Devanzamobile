...
const styles = StyleSheet.create({
  ...
  defaultFlash: {
    ...
    minHeight: OFFSET_HEIGHT + moderateScale(20),
    borderBottomRightRadius: moderateScale(20), borderBottomLeftRadius: moderateScale(20)
  },
  defaultFlashCenter: {
    margin: 44,
    borderRadius: 8,
  ...
  flashText: {
    ...
    lineHeight: 18,
    color: "#fff", textAlign: 'center', textTransform: 'capitalize', fontFamily: FONT_FAMILY, fontWeight: '500'
  },
  flashTitle: {
    fontSize: 16,
    fontWeight: "600",
