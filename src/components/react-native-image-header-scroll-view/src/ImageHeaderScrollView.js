...
class ImageHeaderScrollView extends Component<Props, State> {
  ...
  renderHeader() {
    ...
    const Opacity = this.state.scrollY.interpolate({
      inputRange: [this.props.maxHeight, this.props.maxHeight],
      outputRange: [0, 1],
    ...
    return (
      <Animated.View style={[styles.header, headerTransformStyle, this.props.headerContainerStyle, { opacity: Opacity }]}>
  ...
  renderForeground() {
    ...
    const Opacity = this.state.scrollY.interpolate({
      inputRange: [moderateScale(100), this.props.maxHeight - moderateScale(200)],
      outputRange: [1, 0],
      useNativeDriver: true,
      extrapolate: 'clamp',
    });
      ...
      >
        ...
        <ScrollViewComponent
          ...
          style={[styles.container, style, {
            ...
            borderTopRightRadius: moderateScale(30), borderTopLeftRadius: moderateScale(30),
          }]}
          onScroll={
            useNativeDriver
